...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+6,"ld", false,-1);
    tracep->declBus(c+7,"v", false,-1, 7,0);
    ...
    tracep->declBus(c+1,"count", false,-1, 7,0);
    tracep->declBit(c+2,"ld_d", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelf->top__DOT__count),8);
    bufp->fullBit(oldp+2,(vlSelf->top__DOT__myCounter__DOT__ld_d));
    ...
    bufp->fullBit(oldp+6,(vlSelf->ld));
    bufp->fullCData(oldp+7,(vlSelf->v),8);
    bufp->fullSData(oldp+8,(vlSelf->bcd),12);
    bufp->fullIData(oldp+9,(8U),32);
    bufp->fullCData(oldp+10,(vlSelf->top__DOT__myCounter__DOT__v),8);
